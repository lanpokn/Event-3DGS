...
# 指定输入文件路径
input_file = 'D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps_old.txt'
# 指定输出文件路径
output_file = "D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps_old2.txt"

# 调用函数进行处理
swap_lines(input_file, output_file)
# 指定输入文件路径
input_file = 'D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps_old2.txt'
# 指定输出文件路径
output_file = "D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps.txt"
...
input_file = "D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps_old2.txt"
# 指定输出文件路径
output_file = "D:/2024/3DGS/PureEventFilter/data/urban_colmap_easy/image_timestamps_e2.txt"
